...
def epsilon_greedy(bandit, horizon, epsilon, seed, *args):
...
def thompson_sampling(bandit, horizon, *args):
    pass
...
rew = algorithms[args.algorithm](bandit_instance, args.horizon, args.epsilon, algo_randSeed)
